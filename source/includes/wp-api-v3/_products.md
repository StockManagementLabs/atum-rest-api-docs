...
| `atum_selectable_inventories`      | string | Limit result set to products with a specific selectable inventories option. Options: `yes`, `no` and `global`. <i class="label label-addon">Multi-Inventory</i> <i class="label label-atum">ATUM</i>              |
| `atum_selectable_inventories_mode` | string | Limit result set to products with a specific selectable inventories mode option. Options: `dropdown`, `list` and `global`. <i class="label label-addon">Multi-Inventory</i> <i class="label label-atum">ATUM</i>  |
